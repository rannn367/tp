...
public class AddCustomerCommandParser implements Parser<AddCustomerCommand> {
    ...
    public AddCustomerCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args,
                ...
                PREFIX_REWARD_POINTS, PREFIX_VISIT_COUNT, PREFIX_FAVORITE_ITEM, PREFIX_TOTAL_SPENT, PREFIX_RATING);
        ...
        int rating = Integer.parseInt(argMultimap.getValue(PREFIX_RATING).get());
