...
public class TypicalDrinks {
    public static final Drink ESPRESSO = new Drink(
            new DrinkName("Espresso"), new Price(3.50), new Category("Coffee"));
    public static final Drink CAPPUCCINO = new Drink(
            new DrinkName("Cappuccino"), new Price(4.50), new Category("Coffee"));
    public static final Drink LATTE = new Drink(
            new DrinkName("Latte"), new Price(4.50), new Category("Coffee"));
    public static final Drink MOCHA = new Drink(
            new DrinkName("Mocha"), new Price(5.00), new Category("Coffee"));
    public static final Drink GREEN_TEA = new Drink(
            new DrinkName("Green Tea"), new Price(3.00), new Category("Tea"));
    public static final Drink BLACK_TEA = new Drink(
            new DrinkName("Black Tea"), new Price(3.00), new Category("Tea"));
    public static final Drink EARL_GREY = new Drink(
            new DrinkName("Earl Grey"), new Price(3.50), new Category("Tea"));
    public static final Drink CHAMOMILE = new Drink(
            new DrinkName("Chamomile"), new Price(3.50), new Category("Tea"));
    public static final Drink ORANGE_JUICE = new Drink(
            new DrinkName("Orange Juice"), new Price(4.00), new Category("Cold Drinks"));
    public static final Drink APPLE_JUICE = new Drink(
            new DrinkName("Apple Juice"), new Price(4.00), new Category("Cold Drinks"));
    public static final Drink ICED_COFFEE = new Drink(
            new DrinkName("Iced Coffee"), new Price(4.50), new Category("Cold Drinks"));
