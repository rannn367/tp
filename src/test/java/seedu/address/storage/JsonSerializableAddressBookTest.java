...
public class JsonSerializableAddressBookTest {
    ...
    private static final Path DUPLICATE_PERSON_FILE = TEST_DATA_FOLDER.resolve("duplicateStaffAddressBook.json");
    ...
    void toModelType_duplicateStaff_throwsIllegalValueException() {
        ...
        JsonSerializableAddressBook jsonAddressBook =
                new JsonSerializableAddressBook(staffList, Collections.emptyList());
